  function initMapLatLong() {
    ...
    var modalMapOpen = document.getElementById("js_widget_modal_map__open");
    modalMapOpen.addEventListener("click",function(e){
        document.getElementById('js_ls-modal-map').classList.add('in');
    ...
    var modalMapClose = document.getElementById("js_widget_modal_map__close");
    modalMapClose.addEventListener("click",function(e){
        document.querySelector('.widget-container').firstElementChild.setAttribute('w-latlong', document.getElementById('w-latlong').value.replace(/\s+/g, ''));
        document.getElementById('js_ls-modal-map').classList.remove('in');
    },false);

    var modalMapCloseBtn = document.querySelector("#js_ls-modal-map .close");
